...
import com.bhe.business.system.impl.SysDictBusinessImpl;
...
import com.bhe.controller.admin.article.ArticleManageController;
...
public class JunitBusiness {
	...
	@Autowired
	private SysDictBusinessImpl sysDictBusinessImpl1;
	@Autowired
	private IProductCategoryBusiness categoryBusiness;
	@Autowired
	private IRoleBusiness roleBusiness;
	@Autowired
	private ISurveyItemBusiness surveyItemBusiness;
	@Autowired
	...
	@Test
	public void insert() {
		BusinessData<Boolean> data = new BusinessData<Boolean>();
		SurveyItemEntity surveyItemEntity = new SurveyItemEntity();
		surveyItemEntity.setSurveyid(111231L);
		data = surveyItemBusiness.insertSurveyItem(surveyItemEntity);
