...
//    var URL = window.UEDITOR_HOME_URL || getUEBasePath();
	var URL = "/"+window.location.pathname.split("/")[1]+"/res/common/js/ueditor/";
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        , serverUrl:"/"+window.location.pathname.split("/")[1]+"/admin/uedit"
        ...
        , toolbars: [[
            ...
            'simpleupload', 'insertimage', 'emotion', 'map', 'insertframe', 
